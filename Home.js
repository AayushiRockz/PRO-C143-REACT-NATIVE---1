...
export default class HomeScreen extends Component {
  ...
  getArticle = () => {
    const url = "http://9793-183-87-245-222.ngrok.io/get-article";
    axios
      .get(url)
      .then(response => {
  ...
  likedArticle = () => {
    const url = "http://9793-183-87-245-222.ngrok.io/liked-article";
    axios
      .post(url)
      .then(response => {
        this.getArticle();
  ...
  unlikedArticle = () => {
    const url = "http://9793-183-87-245-222.ngrok.io/disliked-article";
    axios
      .post(url)
      .then(response => {
        this.getArticle();
